...
// Rule 1 & 4 & 5 Guard: Check if logged in
if (!isset($_SESSION['user_logged_in']) || $_SESSION['user_logged_in'] !== true || strlen($_SESSION['alogin']) == "") {
    header("Location: index.php");
    exit();
}

// Rule 4 & 5 Guard: Check if Terms are accepted
if (!isset($_SESSION['terms_accepted']) || $_SESSION['terms_accepted'] !== true) {
    header("Location: terms_conditions.php");
    exit();
}

// Rule 4 & 5 Guard: Check if Age is confirmed
if (!isset($_SESSION['user_age_confirmed']) || $_SESSION['user_age_confirmed'] !== true) {
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content-wrapper">
            <div class="dashboard-card body-card">
                <div class="dashboard-card-header" style="text-align: center; border: none; padding-bottom: 0;">
                    <h3 class="dashboard-card-title">Select Body Area</h3>
                    <p class="dashboard-card-subtitle">Choose the affected body region for symptom analysis</p>
                </div>
